...
import henryandalex.tinkersaddonmod.objects.blocks.item.ItemBlockVariant;
import henryandalex.tinkersaddonmod.utils.IHasModel;
import henryandalex.tinkersaddonmod.utils.handlers.EnumHandler;
...
public class BlockOres extends Block implements IHasModel, henryandalex.tinkersaddonmod.utils.IMetaName {
	...
	public BlockOres(String name, String dimension) {
		...
		public void registerModels()
		{
			for( int i = 0; i < EnumHandler.EnumType.values().length; i++) {
				TCAddonMod.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "ore_" + this.dimension + "_" + EnumHandler.EnumType.values()[i].getName(),"inventory");
			}
		}
}
