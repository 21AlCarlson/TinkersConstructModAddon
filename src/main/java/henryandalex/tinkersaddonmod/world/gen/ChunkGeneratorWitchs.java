...
public class ChunkGeneratorWitchs implements IChunkGenerator {
    ...
    protected Biome biome = BiomeInit.WITCHS_SWAMP;
    protected IBlockState baseBlock = BlockInit.WITCHS_GRASS.getDefaultState();
    ...
    protected MapGenWitchsSwampVillage villageGenerator = new MapGenWitchsSwampVillage();
    ...
    public ChunkGeneratorWitchs(World worldIn) {
        ...
        /* do we need this? */
        MapGenVillage.VILLAGE_SPAWN_BIOMES.add(BiomeInit.WITCHS_SWAMP);
    ...
    protected void postTerrainGenEvents() {
        ...
        strongholdGenerator = (MapGenStronghold) TerrainGen.getModdedMapGen(strongholdGenerator, InitMapGenEvent.EventType.STRONGHOLD);
        	...
        	villageGenerator = (MapGenWitchsSwampVillage) TerrainGen.getModdedMapGen(villageGenerator, InitMapGenEvent.EventType.VILLAGE);
     ...
     * 
     * <p>**From https://github.com/jabelar/ExampleMod-1.12</p>
     */
	...
	public void populate(int chunkX, int chunkZ) {
        ...
        int chunkStartXInWorld = chunkX * 16;
        int chunkStartZInWorld = chunkZ * 16;
        ...
        ForgeEventFactory.onChunkPopulate(true, this, world, rand, chunkX, chunkZ, villageHasGenerated);
        ...
        if (useWaterLakes && !villageHasGenerated && rand.nextInt(waterLakeChance) == 0)
            if (TerrainGen.populate(this, world, rand, chunkX, chunkZ, villageHasGenerated, PopulateChunkEvent.Populate.EventType.LAKE)) {
        ...
        if (useLavaLakes && !villageHasGenerated && rand.nextInt(lavaLakeChance / 10) == 0)
            if (TerrainGen.populate(this, world, rand, chunkX, chunkZ, villageHasGenerated, PopulateChunkEvent.Populate.EventType.LAVA)) {
        ...
        if (useDungeons)
            if (TerrainGen.populate(this, world, rand, chunkX, chunkZ, villageHasGenerated, PopulateChunkEvent.Populate.EventType.DUNGEON)) {
         ...
         * Spawn creatures
         */
        if (TerrainGen.populate(this, world, rand, chunkX, chunkZ, villageHasGenerated, PopulateChunkEvent.Populate.EventType.CUSTOM)) {            
            WorldEntitySpawner.performWorldGenSpawning(world, biome, chunkStartXInWorld + 8, chunkStartZInWorld + 8, 16, 16, rand);
        }
        
        ForgeEventFactory.onChunkPopulate(false, this, world, rand, chunkX, chunkZ, villageHasGenerated);
