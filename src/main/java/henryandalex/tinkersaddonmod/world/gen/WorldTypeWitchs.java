...
public class WorldTypeWitchs extends WorldType {

	public WorldTypeWitchs() {
		super(BiomeWitchsSwamp.NAME);
	}
    ...
    {
        return new BiomeProviderWitchs();
    }
    ...
    {
        return new ChunkGeneratorWitchs(world);
    }
